  ...
  <div class="container-manage">
      ...
      <%}%>
          <div class="panel-heading">
            <h3 class="panel-title">待审批合同列表</h3>
          </div>        
          <div class="panel-body"><!--panel body start-->
            <form class="form-horizontal" role="form" action="ContractManageApprove" method="get">            
              <div class="form-group">
                <label class="col-sm-2 control-label">待审批合同名称：</label>
            ...
            <table class="table table-hover table-condensed table-white"  style="color:#ffffff;">
                ...
                <% for(int i=0;i<contracts.size();i++){ %>
                	 ...
                	 <td><%=((Contract)contracts.get(i)).GetId()%></td>
                		...
                		<td><a href="ContractManageApprove?type=detail&id=<%=contracts.get(i).GetId() %>">审批</a></td>
                	</tr>
                <%}%>
                </tbody>
            </table>
