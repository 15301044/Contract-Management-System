...
<body>
  ...
  <div class="container-manage">
	  ...
	  <script type="text/javascript">
	  	document.getElementById("qdht").setAttribute("class","list-group-item bg active");
	  	function reset() {
	        document.getElementById("qdxx").value = "";    
	    }
	  </script>
	  <div class="panel panel-default col-sm-10 bg"><!--panel start-->
          <div class="panel-heading">
            <h3 class="panel-title">签订合同</h3>
          </div>  
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="ContractManageSign?type=signOper&contractNo=<%=contract.GetId()%>" method="post">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">签订信息：</label>
                    <div class="col-sm-9" style="margin-top:10px;">
                      <textarea id="qdxx" name="qdxx" maxlength="100" class="form-control" rows="4"></textarea>
                    </div>              
                </div>               
                <div class="form-group">
