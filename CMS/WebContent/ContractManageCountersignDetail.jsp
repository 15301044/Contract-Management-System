...
<body>
  ...
  <script type="text/javascript">
	...
	function reset() {
        document.getElementById("hqyj").value = "";    
    }
  </script>
  ...
  <div class="container-manage">
	  ...
	  <div class="panel panel-default col-sm-10 bg"><!--panel start-->
          <div class="panel-heading">
            <h3 class="panel-title">会签合同</h3>
          </div>  
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="ContractManageCountersign?type=countersignOper&contractNo=<%=contract.GetId() %>" method="post" >
                <div class="form-group">
                    <label for="合同名称" class="col-sm-2 control-label">合同名称：</label>
					<label for="合同名称" class="col-sm-6 control-label" style="text-align:left"><%=contract.GetName()%></label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label  for="合同内容" class="col-sm-2 control-label" >会签意见：</label>
                    <div class="col-sm-9" style="margin-top:10px;">
                      <textarea id="hqyj" name="hqyj" class="form-control" rows="4" maxlength="100"></textarea>
                    </div>              
                </div>
                <div class="form-group">
