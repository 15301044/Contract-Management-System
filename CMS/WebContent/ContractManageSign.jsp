  ...
  <div class="container-manage">
      ...
      <%}%> 
          <div class="panel-heading">
            <h3 class="panel-title">待签订合同列表</h3>
          </div>        
          <div class="panel-body"><!--panel body start-->
            <form class="form-horizontal" role="form" action="ContractManageSign" method="get">            
              <div class="form-group">
                <label class="col-sm-2 control-label">待签订合同名称：</label>
            ...
            <table class="table table-hover table-condensed table-white" style="color:#ffffff;">
                ...
                <% for(int i=0;i<contracts.size();i++){ %>
                	<tr>
                		...
                		<td><a href="ContractManageSign?type=detail&id=<%=((Contract)contracts.get(i)).GetId()%>">签订</a></td>
                	</tr>
                <%}%>
                </tbody>
            </table>
